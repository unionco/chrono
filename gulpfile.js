var fs = require('fs'),
  ...
  config = {
    browserSync_proxy: 'dev.chrono.com',
    bower_path: './bower_components/',
    template_src: ['*.html', '*.twig', '*.blade.php', '**/*.html', '**/*.twig', '**/*.blade.php'],
    js_src: ['_private/js/*.js', '_private/js/**/*.js'],
    sass_src: ['_private/scss/*.scss', '_private/scss/**/*.scss'],
    img_src: ['_private/img/**/*', '_private/img/*'],
    js_dist: 'assets/js/',
    js_clean_path: 'assets/js/**/*',
    css_dist: 'assets/css/',
    css_clean_path: 'assets/css/**/*',
    img_dist: 'assets/img/'
  };
/*
